<template>
  ...
  <div class="content">
    <div class="width1190">
      <h2 class="title">租房 <a href="https://xz.fang.com/">更多&gt;&gt;</a></h2>
      <div class="index-fang-list">
        <dl>
          <dt><a href="https://xz.newhouse.fang.com/house/s/"><img src="images/fang1.jpg" width="286" height="188" /></a></dt>
          <dd>
            <h3><a href="https://xz.newhouse.fang.com/house/s/"></a>云龙区花园新村</h3>
            <div class="hui">3室2厅2卫 | 147m² | 精装修</div>
          </dd>
        </dl>
        <dl>
          <dt><a href="https://xz.newhouse.fang.com/house/s/"><img src="images/fang2.jpg" width="286" height="188" /></a></dt>
          <dd>
            <h3><a href="https://xz.newhouse.fang.com/house/s/"></a>铜山公寓</h3>
            <div class="hui">3室2厅2卫 | 147m² | 精装修</div>
          </dd>
        </dl>
        <dl>
          <dt><a href="https://xz.newhouse.fang.com/house/s/"><img src="images/fang3.jpg" width="286" height="188" /></a></dt>
          <dd>
            <h3><a href="https://xz.newhouse.fang.com/house/s/"></a>嘉和园小区</h3>
            <div class="hui">3室2厅2卫 | 147m² | 精装修</div>
          </dd>
        </dl>
      ...
      <h2 class="title">新房 <a href="pro_xin.html">更多&gt;&gt;</a></h2>
      <div class="index-fang-list">
        <dl>
          <dt><a href="https://xz.newhouse.fang.com/house/s/"><img src="images/fang5.jpg" width="286" height="188" /></a></dt>
          <dd>
            <h3><a href="https://xz.newhouse.fang.com/house/s/"></a>泉山花苑1号楼201</h3>
            <div class="hui">3室2厅2卫 | 147m² | 精装修</div>
          </dd>
        </dl>
        <dl>
          <dt><a href="https://xz.newhouse.fang.com/house/s/"><img src="images/fang6.jpg" width="286" height="188" /></a></dt>
          <dd>
            <h3><a href="https://xz.newhouse.fang.com/house/s/"></a>双龙小区2号楼</h3>
            <div class="hui">3室2厅2卫 | 147m² | 精装修</div>
          </dd>
        </dl>
        <dl>
          <dt><a href="https://xz.newhouse.fang.com/house/s/"><img src="images/fang7.jpg" width="286" height="188" /></a></dt>
          <dd>
            <h3><a href="https://xz.newhouse.fang.com/house/s/"></a>铜山区泉河花园</h3>
            <div class="hui">3室2厅2卫 | 147m² | 精装修</div>
          </dd>
        </dl>
        <div class="clears"></div>
      ...
      <h2 class="title">二手房 <a href="https://xz.fang.com/">更多&gt;&gt;</a></h2>
      <div class="index-ershou">
        <div class="in-er-left">
          <a href="https://xz.newhouse.fang.com/house/s/"><img src="images/fangt1.jpg" width="380" height="285" /></a>
          <div class="in-er-left-text"><strong class="fl">有经济头脑的人懂得现在入手</strong><strong class="fr alignRight">¥2841</strong></div>
        </div><!--in-er-left/-->
        <div class="in-er-right">
          <dl>
            <dd>
              <h3><a href="https://xz.newhouse.fang.com/house/s/">贾汪区半岛世纪城</a></h3>
              <div class="in-er-right-text">
                该地区的建筑风格独特，绿化环境优美，设施齐全，配备了各种现代化设施和便利设施，包括商场、健身房、游泳池等。
              </div>
          ...
          <dl>
            <dd>
              <h3><a href="https://xz.newhouse.fang.com/house/s/">云龙区望龙花园</a></h3>
              <div class="in-er-right-text">
                该地区的建筑风格独特，绿化环境优美，设施齐全，配备了各种现代化设施和便利设施，包括商场、健身房、游泳池等。
              </div>
              <div class="price">¥<strong>7890</strong></div>
            </dd>
            <div class="clears"></div>
          </dl>
          <dl>
            <dd>
              <h3><a href="https://xz.newhouse.fang.com/house/s/">绿地世界城</a></h3>
              <div class="in-er-right-text">
                该地区的建筑风格独特，绿化环境优美，设施齐全，配备了各种现代化设施和便利设施，包括商场、健身房、游泳池等。
              </div>
              <div class="price">¥<strong>1890</strong></div>
            </dd>
            <div class="clears"></div>
          </dl>
          <dl>
            <dd>
              <h3><a href="https://xz.newhouse.fang.com/house/s/">南三环路小区</a></h3>
              <div class="in-er-right-text">
                该地区的建筑风格独特，绿化环境优美，设施齐全，配备了各种现代化设施和便利设施，包括商场、健身房、游泳池等。
              </div>
              <div class="price">¥<strong>9890</strong></div>
            </dd>
            <div class="clears"></div>
          </dl>
          <div class="clears"></div>
...
/*banner*/
.banner{height:373px; margin-left: 15rem}

/*xinren*/
.xinren{padding:30px 0;margin-left: 10rem; margin-top:5rem}
...
/*content*/
.content{padding:10px 0;margin-left:15rem;}
